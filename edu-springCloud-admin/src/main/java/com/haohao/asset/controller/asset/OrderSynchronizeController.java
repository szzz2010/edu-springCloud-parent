...
public class OrderSynchronizeController {
	...
	private final static Logger log = LoggerFactory.getLogger(OrderSynchronizeController.class);
	...
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/api/assetsCenter/commonData/commonRequest", method = { RequestMethod.POST, RequestMethod.GET })
