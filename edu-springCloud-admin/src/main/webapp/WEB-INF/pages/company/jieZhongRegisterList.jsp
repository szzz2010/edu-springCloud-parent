			...
			<div class="form_conten">
				<form class="layui-form" id="searchForm">
					<div class="layui-form-item">
						...
						<div class="layui-inline">
							<label class="layui-form-label">申请注册时间</label>
							<div class="layui-input-inline">
...
<script type="text/javascript">
    ...
    function loadData(select,usccCodeOrNameOrMobile,createStartTime,createEndTime,checkStartTime,checkEndTime,status) {
        ...
        layui.use('table', function () {
            ...
            table.render({
                elem: '#table-list',
                url: "dataRegister?select="+select+"&usccCodeOrNameOrMobile="+usccCodeOrNameOrMobile+"&createStartTime="+createStartTime
                ...
                cols: [[
                    ...
                    , {field: 'usccCode', title: '统一社会信用代码', align: 'center'}
                    , {
                    ...
                    , {field: 'createTime', title: '申请注册时间', align: 'center'}
                    , {field: 'registerCheckTime', title: '审核完成时间', align: 'center'}
                    , {
                        ...
                        , templet: function (d) {
                            ...
                            /* return '<a href="javascript:void(0);"  onclick="toCompanyDetail(' + d.id + ')"  style="color:blue;">详情</a>'; */
                            return '';
                        }
                    }
                ]]
